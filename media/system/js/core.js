...
Joomla.submitform = function (a, b) {
  if (
    "undefined" === typeof b &&
    ((b = document.getElementById("adminForm")), !b)
  )
...
Joomla.JText = {
  strings: {},
  _: function (a, b) {
    return "undefined" !== typeof this.strings[a.toUpperCase()]
      ? this.strings[a.toUpperCase()]
      : b;
  },
  load: function (a) {
...
Joomla.renderMessages = function (a) {
  ...
  var b = document.id("system-message-container"),
    c = new Element("dl", { id: "system-message", role: "alert" });
  Object.each(
    a,
    function (a, b) {
...
Joomla.tableOrdering = function (a, b, c, d) {
  if (
    "undefined" === typeof d &&
    ((d = document.getElementById("adminForm")), !d)
  )
...
function checkAll(a, b) {
  ...
  for (
    var e = document.adminForm, c = e.toggle.checked, f = a, g = 0, d = 0;
    d < f;
    d++
  ) {
    var h = e[b + "" + d];
...
function submitform(a) {
  ...
  "function" == typeof document.adminForm.fireEvent &&
