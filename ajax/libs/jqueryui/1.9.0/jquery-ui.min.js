(function (e, t) {
  ...
  function s(t) {
    return !e(t)
      ...
      .filter(function () {
        return (
          e.css(this, "visibility") === "hidden" || e.expr.filters.hidden(this)
        );
      }).length;
  }
  var n = 0,
  ...
  (function (e, t) {
    ...
    (e.cleanData = function (t) {
      ...
      (e.Widget.prototype = {
        ...
        _on: function (t, n) {
          n
            ? ((t = e(t)), (this.bindings = this.bindings.add(t)))
            : ((n = t), (t = this.element));
          var r = this;
          e.each(n, function (n, i) {
            ...
            typeof i != "string" &&
              (s.guid = i.guid = i.guid || s.guid || e.guid++);
            var o = n.match(/^(\w+)\s*(.*)$/),
      ...
      _contactContainers: function (t) {
        ...
        if (this.containers.length === 1)
          ...
          for (var a = this.items.length - 1; a >= 0; a--) {
            if (
              !e.contains(this.containers[r].element[0], this.items[a].item[0])
            )
              continue;
            var f = this.containers[r].floating
      ...
      _create: function () {
        ...
        var t = this,
          ...
          a = e("<a href='#'></a>")
            ...
            .appendTo(u),
          f = (this.uiDialogTitlebarCloseText = e("<span>"))
          ...
          l = e("<span>")
            ...
            .html(i)
            .prependTo(u),
          c = (this.uiDialogButtonPane = e("<div>")).addClass(
            "ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"
          ),
          h = (this.uiButtonSet = e("<div>"))
            .addClass("ui-dialog-buttonset")
            .appendTo(c);
        s.attr({ role: "dialog", "aria-labelledby": l.attr("id") }),
          ...
          (a = a.concat(["marginTop", "marginBottom"]).concat(u)),
            ...
            r.find("*[width]").each(function () {
              ...
              c && e.effects.save(n, o),
                ...
                (n.to = { height: r.height * m.to.y, width: r.width * m.to.x }),
                m.from.y !== m.to.y &&
                  ((n.from = e.effects.setTransition(n, a, m.from.y, n.from)),
                  (n.to = e.effects.setTransition(n, a, m.to.y, n.to))),
                m.from.x !== m.to.x &&
                  ((n.from = e.effects.setTransition(n, f, m.from.x, n.from)),
    ...
    e.widget("ui.tabs", {
      ...
      _create: function () {
        ...
        (this.running = !1),
          this.element
            ...
            .toggleClass("ui-tabs-collapsible", r.collapsible)
            .delegate(
              ".ui-tabs-nav > li",
      ...
      refresh: function () {
        ...
        (n.disabled = e.map(r.filter(".ui-state-disabled"), function (e) {
          ...
          this._processTabs(),
          n.active === !1 || !this.anchors.length
            ? ((n.active = !1), (this.active = e()))
            : this.active.length && !e.contains(this.tablist[0], this.active[0])
            ? this.tabs.length === n.disabled.length
              ? ((n.active = !1), (this.active = e()))
              : this._activate(this._findNextTab(Math.max(0, n.active - 1), !1))
            : (n.active = this.tabs.index(this.active)),
          this._refresh();
      },
      _refresh: function () {
    ...
    e.widget("ui.tooltip", {
      ...
      open: function (t) {
        ...
        if (this.options.track && n.data("ui-tooltip-id")) {
          this._find(n).position(e.extend({ of: n }, this.options.position)),
        ...
        r.is("[title]") &&
          ...
          this.options.track && t && /^mouse/.test(t.originalEvent.type)
            ? ((o = e.extend({}, this.options.position)),
              this._on(this.document, { mousemove: u }),
              u(t))
      ...
      close: function (t, n) {
        ...
        if (
          ...
          t &&
          t.type !== "focusout" &&
          this.document[0].activeElement === s[0]
        )
          return;
